...
<div class="formbody">
  <div class="usual">
    ...
    此处需要自己设计UserBean jsp:useBean …
    **********************************
    <jsp:useBean id="user"  class="com.javabean.User" scope="request" ></jsp:useBean>
    <form name="frm" action="manage/userUpdateOper.jsp" method="post">
      <div class="tabson">
        <ul class="forminfo">
          ...
          <li>
            <label>真实姓名<b>*</b></label>m
            此处需要自己填写value
            <input name="userRealname" value='<jsp:getProperty property="userRealname" name="user"/>'
