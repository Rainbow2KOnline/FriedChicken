        ...
        <div class="tabson">
            <ul class="forminfo">
                ...
                <li>
                    ...
                    <b style="color: #000">	${requestScope.resume.currentLoc}</b></label>
                </li>
                <li>
                    <label>户口所在地：</label><label style="width: 200px;">
                    <b style="color: #000">	${requestScope.resume.residentLoc}</b></label>
                </li>
                <li>
                    <label>手机号：</label><label style="width: 200px;">
                    <b style="color: #000">${requestScope.resume.telephone}</b></label>
                </li>
                <li>
                ...
                <li>
                    ...
                    <b style="color: #000">${requestScope.resume.jobIntension}</b></label>
                </li>
                <li>
                    <label>工作经验：</label><label style="width: 200px;">
                    <b style="color: #000">${requestScope.resume.jobExperience}</b></label>
                </li>
            </ul>
        </div>
    </div>
